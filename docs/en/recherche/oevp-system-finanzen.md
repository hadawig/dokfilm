...
1. **The Long March:** Rise through party leagues and state organizations.
2. **The Post-Architecture:** Filling key positions in ministries and state-related companies (Example: Thomas Schmid).
3. **Absolute Loyalty:** A resignation only occurs in an absolute emergency; before that, any criticism is dismissed as "criminalization of politics."
